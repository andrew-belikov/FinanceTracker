...
- `/history` — строится график стоимости, собственных пополнений и отдельная линия вычетов ИИС, а максимум портфеля отмечается красной точкой с датой и значением.
