...
- Telegram‑бот:
  ...
  - команда `/calendar` показывает ожидаемые купоны и объявленные дивиденды по текущим позициям на следующие 90 дней, а для купонов с надёжным периодом — простой годовой эквивалент выплаты к cost basis;
