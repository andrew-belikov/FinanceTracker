...
- `/year` — приходит summary за год, PNG-график с помесячными столбцами (стоимость портфеля и пополнения) и третье сообщение с блоками изменений позиций по группам (по умолчанию текущий год YTD).
