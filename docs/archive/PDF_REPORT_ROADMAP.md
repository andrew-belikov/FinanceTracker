# Архив: PDF Report Roadmap

> Исторический план до package-layout и opt-in Ollama. Он не описывает текущий
> runtime; используйте [`../PDF_REPORT.md`](../PDF_REPORT.md),
> [`../ARCHITECTURE.md`](../ARCHITECTURE.md) и [`../CONFIG.md`](../CONFIG.md).
...
- [src/bot/queries.py](../../src/bot/queries.py)
- [src/bot/services.py](../../src/bot/services.py)
- [tests/test_month_positions_diff.py](../../tests/test_month_positions_diff.py)
- новый `tests/test_report_payload.py`
- [docs/PDF_REPORT_TECH.md](../PDF_REPORT_TECH.md)
...
- [src/bot/charts.py](../../src/bot/charts.py)
- `src/bot/report_pipeline.py`
- новый `tests/test_report_render.py`
- [docs/PDF_REPORT.md](../PDF_REPORT.md)
...
- [src/bot/bot.py](../../src/bot/bot.py)
- [src/bot/runtime.py](../../src/bot/runtime.py)
- [src/bot/services.py](../../src/bot/services.py)
...
- [src/bot/jobs.py](../../src/bot/jobs.py)
- [src/bot/runtime.py](../../src/bot/runtime.py)
