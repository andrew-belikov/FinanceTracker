# Архив: PDF Report Technical Design

> Исторический технический контекст. Актуальные contracts находятся в
> [`../PDF_REPORT.md`](../PDF_REPORT.md) и [`../CONTRACTS.md`](../CONTRACTS.md).
