...
RUNTIME_FILES = [
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "bot.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "charts.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "dataset.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "entrypoint.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "handlers.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "jobs.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_ai.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "report_client.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_entrypoint.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_pipeline.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_payload.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_render.py",
    PROJECT_ROOT / "src" / "financetracker" / "reporting" / "report_server.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "proxy_smoke.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "queries.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "runtime.py",
    PROJECT_ROOT / "src" / "financetracker" / "bot" / "services.py",
    PROJECT_ROOT / "src" / "financetracker" / "tracker" / "app.py",
    PROJECT_ROOT / "src" / "financetracker" / "tracker" / "repair_operations_description_encoding.py",
    PROJECT_ROOT / "src" / "financetracker" / "xray" / "entrypoint.py",
    PROJECT_ROOT / "src" / "financetracker" / "xray" / "healthcheck.py",
]
