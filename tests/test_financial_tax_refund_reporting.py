...
PAYLOAD_AI_INPUT_FILE = PROJECT_ROOT / "src" / "financetracker" / "reporting" / "payload_ai_input.py"
...
class TaxRefundReportingTests(unittest.TestCase):
    def test_ai_facts_keep_refund_separate_from_tax_expense(self):
        ...
        overview = load_function(PAYLOAD_AI_INPUT_FILE, "_build_overview_facts", namespace)(build_payload())
        cashflow = load_function(PAYLOAD_AI_INPUT_FILE, "_build_cashflow_facts", namespace)(build_payload())
