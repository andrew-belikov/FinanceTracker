...
class StartupReadinessContractTests(unittest.TestCase):
    ...
    def test_tracker_initial_sync_failure_exits_before_scheduler(self):
        ...
        namespace = {
            ...
            "os": __import__("os"),
            "run_container_smoke_if_requested": lambda **_kwargs: False,
            "ContainerSmokeConfigurationError": RuntimeConfigurationError,
            "APP_ENV": "test",
            "write_tracker_ready_state": lambda: calls.append("ready"),
        }
