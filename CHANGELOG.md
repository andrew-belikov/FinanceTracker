...
- Первый стабильный релиз FinanceTracker: модульная архитектура, формализованные API и конфигурационные контракты, PostgreSQL migrations и production-ready Docker deploy.
- Добавлены CI gates, restore drill перед deploy, health checks, структурированное безопасное логирование и regression-проверки расчётов.
- Проверены production-derived данные, API reporter и финансовые вычисления перед выпуском.
