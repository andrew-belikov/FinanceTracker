...
from financetracker.reporting.payout_calendar import (
    render_payout_calendar_text as render_reporting_payout_calendar_text,
)
...
def render_payout_calendar_text(rows: list[dict] | None, *, start_date: date, end_date: date, heading: str) -> str:
    return render_reporting_payout_calendar_text(
        rows,
