...
> Исторический audit конкретного commit. Не используйте его как описание
> текущего runtime-состояния или как эксплуатационную инструкцию: действующие
> источники перечислены в [`docs/README.md`](docs/README.md).
